...
def local_setup()-> None:
    root = os.path.join(os.path.expanduser('~'), "sdg_predictor")
...
if __name__ == '__main__':
    local_setup()
    data_path, model_path, model_train, model_evaluate = local_setup()
    #print("✅ Setup done")
    #preprocess()
    #print("✅ Process done")
    #train()
